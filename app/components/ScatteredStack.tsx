...
const ICONS: Record<string, { icon: React.ReactNode; bg: string }> = {
  JavaScript: {
    ...
    icon: (
      <svg viewBox="0 0 24 24" width="48" height="48">
        <text x="50%" y="65%" dominantBaseline="middle" textAnchor="middle" fill="#000000" fontSize="14" fontWeight="bold" fontFamily="sans-serif">JS</text>
      </svg>
    ),
  },
  TypeScript: {
  ...
  "Next.js": {
    ...
    icon: (
      <svg viewBox="0 0 24 24" width="48" height="48">
        <path fill="#ffffff" d="M12 4C7.588 4 4 7.588 4 12s3.588 8 8 8 8-3.588 8-8-3.588-8-8-8zm-.5 12V8l6 4-6 4z"/>
      </svg>
    ),
  },
  "React.js": {
